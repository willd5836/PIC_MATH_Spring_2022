...
for (i in c(1:83))
{
  ...
  ts.plot(Series1, Series2, Series3, Series4, Series5, gpars=list(xlab="Year", ylab="Value (in Millions of U.S. Dollars)",lty=c(1:5)), col=rep(c("red","purple","black","green","blue")))
...
unfilledorders_mmv_ordered_mean_unadj <- unfilledorders_mmv_ordered_mean %>% select(starts_with('U')) #50 Columns
for (i in c(1:46))
{
...
unfilledorders_mmv_ordered_median_unadj <- unfilledorders_mmv_ordered_median %>% select(starts_with('U')) #50 Columns
for (i in c(1:46))
{
...
shipments_mmv_ordered_standev_adj <- shipments_mmv_ordered_standev %>% select(starts_with('A')) #87 Columns
shipments_mmv_ordered_standev_unadj <- shipments_mmv_ordered_standev %>% select(starts_with('U')) #87 Columns
for (i in c(1:83))
{
...
unfilledorders_mmv_ordered_standev_adj <- unfilledorders_mmv_ordered_standev %>% select(starts_with('A')) #52 Columns
