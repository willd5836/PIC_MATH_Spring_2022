...
for (i in c(1:81))
{
  ...
  ggplot(data = shipments_mmv_ordered_mean_adj[,i],aes(x = Year,y = Value, col = variable)) + geom_line() +
  ggplot(data = shipments_mmv_ordered_mean_adj[,i+1],aes(x = Year,y = Value, col = variable)) + geom_line() +
  ggplot(data = shipments_mmv_ordered_mean_adj[,i+2],aes(x = Year,y = Value, col = variable)) + geom_line() +
  ggplot(data = shipments_mmv_ordered_mean_adj[,i+3],aes(x = Year,y = Value, col = variable)) + geom_line() +
  ggplot(data = shipments_mmv_ordered_mean_adj[,i+3],aes(x = Year,y = Value, col = variable)) + geom_line()
