...
for (i in c(1,6,11,16,21,26,31,36,41,46,51,56,61,66,71,76,81,86,91,96,101,106,111,116,121,126,131,136,141,146,151,156,161,166,171))
{
  Series1 <- ts(data = shipments_mmv_ordered_mean[,i], start=c(1992), end=c(2021), frequency = 12)
  Series2 <- ts(data = shipments_mmv_ordered_mean[,i+1], start=c(1992), end=c(2021), frequency = 12)
  Series3 <- ts(data = shipments_mmv_ordered_mean[,i+2], start=c(1992), end=c(2021), frequency = 12)
  Series4 <- ts(data = shipments_mmv_ordered_mean[,i+3], start=c(1992), end=c(2021), frequency = 12)
  Series5 <- ts(data = shipments_mmv_ordered_mean[,i+4], start=c(1992), end=c(2021), frequency = 12)
  ...
  legend("topleft", legend = c(colnames(shipments_mmv_ordered_mean)[i],colnames(shipments_mmv_ordered_mean)[i+1],colnames(shipments_mmv_ordered_mean)[i+2],colnames(shipments_mmv_ordered_mean)[i+3],colnames(shipments_mmv_ordered_mean)[i+4]), col = c("red","purple","black","green","blue"), lty=c(1:4))
}
```
```{r}
...
for (i in c(1,6,11,16,21,26,31,36,41,46,51,56,61,66,71,76,81,86,91,96,101))
{
  Series1 <- ts(data = neworders_mmv_ordered_mean[,i], start=c(1992), end=c(2021), frequency = 12)
  Series2 <- ts(data = neworders_mmv_ordered_mean[,i+1], start=c(1992), end=c(2021), frequency = 12)
  Series3 <- ts(data = neworders_mmv_ordered_mean[,i+2], start=c(1992), end=c(2021), frequency = 12)
  Series4 <- ts(data = neworders_mmv_ordered_mean[,i+3], start=c(1992), end=c(2021), frequency = 12)
  Series5 <- ts(data = neworders_mmv_ordered_mean[,i+4], start=c(1992), end=c(2021), frequency = 12)
  ts.plot(Series1, Series2, Series3, Series4, Series5, gpars=list(xlab="Year", ylab="Value",lty=c(1:5)), col=rep(c("red","purple","black","green","blue")))
  legend("topleft", legend = c(colnames(neworders_mmv_ordered_mean)[i],colnames(neworders_mmv_ordered_mean)[i+1],colnames(neworders_mmv_ordered_mean)[i+2],colnames(neworders_mmv_ordered_mean)[i+3],colnames(neworders_mmv_ordered_mean)[i+4]), col = c("red","purple","black","green","blue"), lty=c(1:4))
}
```
```{r}
...
for (i in c(1,6,11,16,21,26,31,36,41,46,51,56,61,66,71,76,81,86,91,96))
{
  Series1 <- ts(data = unfilledorders_mmv_ordered_mean[,i], start=c(1992), end=c(2021), frequency = 12)
  Series2 <- ts(data = unfilledorders_mmv_ordered_mean[,i+1], start=c(1992), end=c(2021), frequency = 12)
  Series3 <- ts(data = unfilledorders_mmv_ordered_mean[,i+2], start=c(1992), end=c(2021), frequency = 12)
  Series4 <- ts(data = unfilledorders_mmv_ordered_mean[,i+3], start=c(1992), end=c(2021), frequency = 12)
  Series5 <- ts(data = unfilledorders_mmv_ordered_mean[,i+4], start=c(1992), end=c(2021), frequency = 12)
  ts.plot(Series1, Series2, Series3, Series4, Series5, gpars=list(xlab="Year", ylab="Value",lty=c(1:5)), col=rep(c("red","purple","black","green","blue")))
  legend("topleft", legend = c(colnames(unfilledorders_mmv_ordered_mean)[i],colnames(unfilledorders_mmv_ordered_mean)[i+1],colnames(unfilledorders_mmv_ordered_mean)[i+2],colnames(unfilledorders_mmv_ordered_mean)[i+3],colnames(unfilledorders_mmv_ordered_mean)[i+4]), col = c("red","purple","black","green","blue"), lty=c(1:4))
}
```
```{r}
...
for (i in c(1,6,11,16,21,26,31,36,41,46,51,56,61,66,71,76,81,86,91,96,101,106,111,116,121,126,131,136,141,146,151,156,161,166,171,176,181,186,191,201,206,211,216,221,226,231,236,241,246,251,256,261,266,271,276,281,286,291,296,301,306,311))
{
  Series1 <- ts(data = totalinv_mmv_ordered_mean[,i], start=c(1992), end=c(2021), frequency = 12)
  Series2 <- ts(data = totalinv_mmv_ordered_mean[,i+1], start=c(1992), end=c(2021), frequency = 12)
  Series3 <- ts(data = totalinv_mmv_ordered_mean[,i+2], start=c(1992), end=c(2021), frequency = 12)
  Series4 <- ts(data = totalinv_mmv_ordered_mean[,i+3], start=c(1992), end=c(2021), frequency = 12)
  Series5 <- ts(data = totalinv_mmv_ordered_mean[,i+4], start=c(1992), end=c(2021), frequency = 12)
  ts.plot(Series1, Series2, Series3, Series4, Series5, gpars=list(xlab="Year", ylab="Value",lty=c(1:5)), col=rep(c("red","purple","black","green","blue")))
  legend("topleft", legend = c(colnames(totalinv_mmv_ordered_mean)[i],colnames(totalinv_mmv_ordered_mean)[i+1],colnames(totalinv_mmv_ordered_mean)[i+2],colnames(totalinv_mmv_ordered_mean)[i+3],colnames(totalinv_mmv_ordered_mean)[i+4]), col = c("red","purple","black","green","blue"), lty=c(1:4))
}
```
```{r}
...
for (i in c(1,6,11,16,21,26,31,36,41))
{
  Series1 <- ts(data = invtoship_mmv_ordered_mean[,i], start=c(1992), end=c(2021), frequency = 12)
  Series2 <- ts(data = invtoship_mmv_ordered_mean[,i+1], start=c(1992), end=c(2021), frequency = 12)
  Series3 <- ts(data = invtoship_mmv_ordered_mean[,i+2], start=c(1992), end=c(2021), frequency = 12)
  Series4 <- ts(data = invtoship_mmv_ordered_mean[,i+3], start=c(1992), end=c(2021), frequency = 12)
  Series5 <- ts(data = invtoship_mmv_ordered_mean[,i+4], start=c(1992), end=c(2021), frequency = 12)
  ts.plot(Series1, Series2, Series3, Series4, Series5, gpars=list(xlab="Year", ylab="Value",lty=c(1:5)), col=rep(c("red","purple","black","green","blue")))
  legend("topleft", legend = c(colnames(invtoship_mmv_ordered_mean)[i],colnames(invtoship_mmv_ordered_mean)[i+1],colnames(invtoship_mmv_ordered_mean)[i+2],colnames(invtoship_mmv_ordered_mean)[i+3],colnames(invtoship_mmv_ordered_mean)[i+4]), col = c("red","purple","black","green","blue"), lty=c(1:4))
}
```
```{r}
...
for (i in c(1,6,11))
{
  Series1 <- ts(data = unfilltoship_mmv_ordered_mean[,i], start=c(1992), end=c(2021), frequency = 12)
  Series2 <- ts(data = unfilltoship_mmv_ordered_mean[,i+1], start=c(1992), end=c(2021), frequency = 12)
  Series3 <- ts(data = unfilltoship_mmv_ordered_mean[,i+2], start=c(1992), end=c(2021), frequency = 12)
  Series4 <- ts(data = unfilltoship_mmv_ordered_mean[,i+3], start=c(1992), end=c(2021), frequency = 12)
  Series5 <- ts(data = unfilltoship_mmv_ordered_mean[,i+4], start=c(1992), end=c(2021), frequency = 12)
  ts.plot(Series1, Series2, Series3, Series4, Series5, gpars=list(xlab="Year", ylab="Value",lty=c(1:5)), col=rep(c("red","purple","black","green","blue")))
  legend("topleft", legend = c(colnames(unfilltoship_mmv_ordered_mean)[i],colnames(unfilltoship_mmv_ordered_mean)[i+1],colnames(unfilltoship_mmv_ordered_mean)[i+2],colnames(unfilltoship_mmv_ordered_mean)[i+3],colnames(unfilltoship_mmv_ordered_mean)[i+4]), col = c("red","purple","black","green","blue"), lty=c(1:4))
}
```
